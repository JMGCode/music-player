...
const ScrollHeader: FC<Props> = ({ title, height = 324, children }) => {
...
export const ScrollHeaderContent: FC<{ children: React.ReactNode }> = ({
  children,
}) => <div style={{ position: "relative", padding: "0 30px" }}>{children}</div>;
